...
/** Asserts that the given block returns true */
public fun assertTrue(block: ()-> Boolean) : Unit = assertTrue(block.toString(), block)
...
/** Asserts that the given block returns false */
public fun assertNot(block: ()-> Boolean) : Unit = assertNot(block.toString(), block)
...
public fun <T, R> assertNotNull(actual: T?, block: (T) -> R) {
