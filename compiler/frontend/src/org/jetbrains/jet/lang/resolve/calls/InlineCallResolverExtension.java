...
public class InlineCallResolverExtension implements CallResolverExtension {
    ...
    private final Set<DeclarationDescriptor> inlinableParameters = new HashSet<DeclarationDescriptor>();
    ...
    private boolean couldAccessVariable(JetExpression expression) {
        ...
        if (parent instanceof JetValueArgument ||
            ...
            return couldAccessVariable((JetExpression) parent);
    ...
    @Nullable
    private static DeclarationDescriptor getDescriptor(
            @NotNull BasicCallResolutionContext context,
