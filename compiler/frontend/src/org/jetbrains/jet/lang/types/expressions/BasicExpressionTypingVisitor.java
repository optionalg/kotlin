    ...
    public JetTypeInfo visitThisExpression(@NotNull JetThisExpression expression, ExpressionTypingContext context) {
        ...
        switch (resolutionResult.getCode()) {
            ...
            case NO_THIS:
                ...
                break;
            case SUCCESS:
                final ReceiverParameterDescriptor descriptor = resolutionResult.getReceiverParameterDescriptor();
                ...
                context.callResolverExtension.run(new ThisResolvedCall(descriptor, call),
