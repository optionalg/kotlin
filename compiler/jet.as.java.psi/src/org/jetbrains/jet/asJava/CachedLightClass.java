...
public abstract class CachedLightClass extends AbstractLightClass implements PsiExtensibleClass {
    private final ClassInnerStuffCache myInnersCache = new ClassInnerStuffCache(this);

    protected CachedLightClass(PsiManager manager, Language language) {
    ...
    public List<PsiField> getOwnFields() {
        return ContainerUtil.map(getDelegate().getFields(), new Function<PsiField, PsiField>() {
            ...
            public PsiField fun(PsiField field) {
                return new LightField(myManager, field, CachedLightClass.this);
            }
        });
    }
