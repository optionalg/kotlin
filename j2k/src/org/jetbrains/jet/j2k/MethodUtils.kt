...
fun Converter.isOverride(method: PsiMethod): Boolean {
    val overridesMethodNotFromObject = method.getHierarchicalMethodSignature().getSuperSignatures() any {
    ...
    val overridesMethodFromObject = method.getHierarchicalMethodSignature().getSuperSignatures() any {
        it.getMethod().getContainingClass()?.getQualifiedName() == JAVA_LANG_OBJECT
    }
...
fun diretlyOverridesMethodFromObject(method: PsiMethod): Boolean {
